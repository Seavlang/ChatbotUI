                    ...
                    <div className="flex justify-between items-center h-14 p-4 bg-white text-[#004B93] rounded-t-2xl">
                        ...
                        <button onClick={() => setIsExpanded(false)} className="text-gray-600">
                            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13.5 4.68799L4.5 13.688" stroke="#004B93" strokeLinecap="round" stroke-linejoin="round" />
                                <path d="M4.5 4.68799L13.5 13.688" stroke="#004B93" strokeLinecap="round" stroke-linejoin="round" />
                            </svg>
