                ...
                <dialog id={`my_modal_${idx}`} ref={dialogRef} className="modal">
                    ...
                    <div className="modal-box max-w-[770px] max-h-[700px] rounded-lg overflow-y-auto  outline-none ">
                        ...
                        <div className=' mx-10 mt-5 border-b-[0.3px] border-black border-opacity-30  h-[100px]'>
                            <div className="text-3xl text-left font-medium text-primary mb-4">{data.title}</div>
                        ...
                        <div className=' mx-10 my-5 '>
                            ...
                            <div>
                                ...
                                <div className='my-5 flex'>
                                    <div className={`text-white w-16 h-6 font-medium rounded-md flex justify-center items-center ${data?.method == 'POST' ? 'bg-[#49CC90]' : data?.method == 'GET' ? 'bg-[#61AFFE]' : 'bg-[#C9002B]'}`}>{data?.method}</div>
