          ...
          >
            {copySuccess ? (
              ...
              <label className="flex items-center mt-5 mb-3 gap-2 text-gray-700">
                ...
                <span className="text-primary text-xl font-bold">API Service</span>
              </label>
                            ...
                            >
                              ...
                              <div className="col-span-5">
                                <div className="flex justify-start items-center h-full">
                                  <span
                                    className={`text-xs rounded-md font-semibold w-12 h-5 text-white ml-10 flex justify-center items-center ${endpoint.method == "POST"
                                        ? "bg-[#49CC90]"
                                        : endpoint.method == "GET"
                                          ? "bg-[#61AFFE]"
                                          : "bg-[#C9002B]"
