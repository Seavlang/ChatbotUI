      ...
      <div className="flex flex-col gap-2  mx-10 w-[80%] ">
        ...
        <div className="flex items-center mb-6 gap-2">
          <svg width="28" height="28" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect x="3.3335" y="4.23584" width="5" height="5.83333" rx="1" stroke="#004B93" strokeLinejoin="round" />
            <rect x="3.3335" y="13.4023" width="5" height="4.16667" rx="1" stroke="#004B93" strokeLinejoin="round" />
            <rect x="11.6665" y="4.23584" width="5" height="4.16667" rx="1" stroke="#004B93" strokeLinejoin="round" />
            <rect x="11.6665" y="11.7358" width="5" height="5.83333" rx="1" stroke="#004B93" strokeLinejoin="round" />
          </svg>
