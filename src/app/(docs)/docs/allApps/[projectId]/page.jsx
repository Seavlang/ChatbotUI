      ...
      <div className="flex flex-col gap-2  mx-10 w-[80%] ">
        <label className="flex items-center mt-5 mb-3 gap-2 text-gray-700">
          <svg width="28" height="28" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M10 9.16667L12.9167 6.25M14.1667 5L12.9167 6.25M12.9167 6.25L15 8.33333" stroke="#004B93" stroke-linecap="round" />
          </svg>
        ...
        <label className="flex items-center mt-5 mb-3 gap-2 text-gray-700">
          <svg width="24" height="24" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M3 9.75L3.9305 8.8195C4.81283 7.93717 6.2788 8.06935 6.98908 9.09526L7.76644 10.2181C8.43112 11.1781 9.77349 11.367 10.6773 10.6276L11.7241 9.77105C12.5194 9.1204 13.6783 9.17822 14.4048 9.9048L15 10.5" stroke="#004B93" stroke-linecap="round" />
            <path d="M8.625 1.875H5.875C3.66586 1.875 1.875 3.66586 1.875 5.875V8.625M16.125 9.375V12.125C16.125 14.3341 14.3341 16.125 12.125 16.125H5.875C3.66586 16.125 1.875 14.3341 1.875 12.125V11.625" stroke="#004B93" stroke-linecap="round" />
          </svg>
