    ...
    <div className="flex justify-center">
      <div className="w-4/5">
        <div className="min-h-screen bg-white dark:bg-gray-900 dark:text-gray-300">
          <h1 className="mx-10 mt-10 md:mb-5 mb-3 text-xl md:text-4xl  font-medium text-primary dark:text-white">
            Example
          </h1>
          <p className="ml-10 mr-20 mb-5 text-sm md:text-lg dark:text-gray-400">
          ...
          <div className="mx-10 border-b-2  w-[75%] text-sm md:text-lg border-x-2 mb-10 rounded-b-md bg-white dark:bg-gray-800 dark:border-gray-700">
            <CodeBlock
              text={codeString}
              language="html"
