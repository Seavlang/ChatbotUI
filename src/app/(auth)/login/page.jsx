  ...
  return (
    ...
    <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      ...
      <div className="text-center text-sm text-gray-500 dark:text-gray-400">
        Create New Account?{" "}
        <a href="/register" className="text-primary dark:text-blue-400">
          Sign up
        </a>
      </div>
      ...
      <div className="w-full">
        ...
        <button
          className="flex items-center w-full justify-center p-2 border rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
